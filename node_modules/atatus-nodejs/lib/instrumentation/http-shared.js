    ...
    return function (event, req, res) {
      if (event === 'request') {
        ...
        if (isRequestBlacklisted(agent, req)) {
          ...
          var traceparent = req.headers['atatus-apm-traceparent']
  ...
  return function (orig) {
    return function (...args) {
      ...
      if (parent && parent._context && shouldPropagateTraceContext(options)) {
        options.headers['atatus-apm-traceparent'] = parent._context.toString()
      }
      ...
      span.name = req._headers.host
      span.setHttpContext({ url: req.method + ' ' + req._headers.host + req.path })
