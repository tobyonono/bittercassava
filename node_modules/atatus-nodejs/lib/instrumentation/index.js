...
var wrapped = Symbol('atatus-apm-wrapped-function')

Instrumentation.prototype.bindFunction = function (original) {
  if (typeof original !== 'function' || original.name === 'atatusAPMCallbackWrapper') return original
  ...
  original[wrapped] = atatusAPMCallbackWrapper

  return atatusAPMCallbackWrapper

  function atatusAPMCallbackWrapper () {
